...
<?php 
// Si el validador encuentra algo mal al intentar guardar, aquí sale el aviso
if (!empty($message)): 
?> 
...
<form method="POST" action="?route=users.update"> 
    ...
    <?php /* Este input es invisible pero vital. 
             Guarda el ID del usuario para que el sistema sepa a quién estamos 
             cambiándole la info y no edite al que no es. */ ?>
    ...
    <div class="form-group"> 
        ...
        <select id="role" name="role"> 
            <?php 
            // Aquí pinto las opciones de roles que permitimos en el sistema
    ...
    <div class="form-group"> 
        ...
        <select id="status" name="status"> 
            <?php 
            // Lo mismo para el estado: Activo, Inactivo, etc.
